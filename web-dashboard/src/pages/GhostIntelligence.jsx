...
import { Activity, Brain, Clock, Cpu, Ghost, Trash2, Zap, Sparkles, Mic, SendHorizonal } from 'lucide-react';
...
const GhostIntelligence = () => {
  ...
  const { history, intentLocalOnly, setIntentLocalOnly, storageKeys } = useApp();
  const {
    actions,
    sessions,
    learnedMacros,
